...
export default function AddInquiryScreen() {
  ...
  const editInquiry = params.editInquiry ? JSON.parse(params.editInquiry as string) : null;
  const isEditing = !!editInquiry;

  const [title, setTitle] = useState(editInquiry ? editInquiry.title : '');
  const [question, setQuestion] = useState(editInquiry ? editInquiry.question : '');
  const [category, setCategory] = useState(editInquiry ? editInquiry.category || '' : '');
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.infoBox}>
          ...
          <Text style={styles.infoText}>
            {isEditing ? 'You can edit this inquiry until you send it.' : 'Save as draft to edit later, or send directly to our support team.'}
          </Text>
        </View>
